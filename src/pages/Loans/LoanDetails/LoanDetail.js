...
export default ({ history, match: { params } }) => {
  ...
  let badgeType = ['ACTIVE', 'PAID'].includes(loanStatus)
    ? 'success'
    : loanStatus === 'DECLINED'
    ? 'danger'
    : 'warning'
              ...
              <Card className={'card-3'}>
                <CardBody>
                  <p className={'add-border-bottom'}>
                    ...
                    <Badge variant={badgeType}>{loanStatus}</Badge>
                  </p>
                  <p className={'add-border-bottom'}>
                    <span className="key">Loan Amount</span>{' '}
                    <span className="value">N{loan.amount}</span>
                  </p>
                  <p className={'add-border-bottom'}>
                    <span className="key">Interest</span>{' '}
                    <span className="value">
                      N{loan.repayment - loan.amount}
                    </span>
                  </p>
                  <p className={'add-border-bottom'}>
                    <span className="key">Repayment</span>{' '}
                    <span className="value">N{loan.repayment}</span>
                  </p>
                  <p className={'add-border-bottom'}>
                    <span className="key">Tenure</span>{' '}
                    <span className="value"># {tenure.durationInMonths}</span>
                  </p>
                  <p className={'add-border-bottom'}>
                  ...
                  <p className={'add-border-bottom'}>
                    ...
                    <span className="value">N{intervalAmount}</span>
                  </p>
                  <p className={'add-border-bottom'}>
