      ...
      <Content className={styles.content}>
        <div className={styles.CI}>
          <div className={styles.CIFirst}>
            <Card>
              <CardHeader className={styles.CIFirstHeader}>
                ...
                <ProgressBar
                  className={cx(styles.progress, styles.Progress)}
                  percentage={85}
                />
              </CardHeader>
              <CardBody>
          ...
          <div className={styles.CISecond}>
            <Card>
              <CardBody>
                <div className={styles.CIFlex}>
                  <span className={styles.CIHeader}>Savings</span>
                </div>
                <div className={styles.CIFlex}>
                  <span>New Plans</span>
                  <span>67</span>
            ...
            <Card>
              <CardHeader className={styles.CIHeader}>CUSTOMERS</CardHeader>
              <CardBody>
                <Chart
                  type="doughnut2d"
                  width="100%"
                  chart={{
                    ...
                    showLegend: '0',
                    showLabels: '0',
                    palettecolors: '#F7685B,#2ED47A,#FFB946',
                    theme: 'fusion'
                  }}
                  dataFormat="JSON"
